...
const entityRelationshipGroups = Object.freeze({
  ...
  ent_united_states: Object.freeze({
    id: "united_states_census_regions",
    label: "Census Regions and Divisions",
    relationshipTypes: ["child_entities"],
    groups: Object.freeze([
      Object.freeze({
        id: "census_new_england",
      ...
      Object.freeze({
        id: "census_east_north_central",
        label: "Midwest — East North Central",
        entityIds: [
          "ent_illinois",
          "ent_indiana",
          "ent_michigan",
      ...
      Object.freeze({
        id: "census_west_north_central",
        label: "Midwest — West North Central",
        entityIds: [
          "ent_iowa",
          "ent_kansas",
          "ent_minnesota",
      ...
      Object.freeze({
        id: "census_south_atlantic",
        label: "South — South Atlantic",
        entityIds: [
          "ent_delaware",
          "ent_district_of_columbia",
          "ent_florida",
          "ent_georgia_state",
          "ent_maryland",
          "ent_north_carolina",
      ...
      Object.freeze({
        id: "census_east_south_central",
        label: "South — East South Central",
        entityIds: [
          "ent_alabama",
          "ent_kentucky",
          "ent_mississippi",
      ...
      Object.freeze({
        id: "census_west_south_central",
        label: "South — West South Central",
        entityIds: [
          "ent_arkansas",
          "ent_louisiana",
          "ent_oklahoma",
    ...
    unmatchedLabel: "Other United States Child Entities"
  }),
